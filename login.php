    ...
    <div class="container">
      <section id="content">
        ...
        <form action="" method="POST">
          <h1>Login</h1>
          <div>
            <input type="text" placeholder="Username" required="" id="username" name="user_email" value="joken@yahoo.com" />
          </div>
          <div>
            <input type="password" placeholder="Password" required="" id="password" name="user_pass" value="j" />
          </div>
          <div>
