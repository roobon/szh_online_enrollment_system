             ...
             <div class="panel-body"> 
              ...
              <thead>
                ...
                foreach ($Tui as $Tresult) {
                  ...
                  echo '<td>' . $Tresult->PERUNIT *  $Tresult->NOOFUNIT .'</a></td>';
                  echo '<td>'. $Tresult->NOOFLAB.'</td>';
                  echo '<td>'. $Tresult->AMOUNTPERLAB.'</td>';
                  echo '<td>'. $Tresult->AMOUNTPERLAB * $Tresult->NOOFLAB.'</td>';
                ...
                <!--  <th>AY</th>
                  ...
                  if ($grouprowcount > 0){
                        ...
                        foreach ($cur as $result) {
                          echo '<tr>';
                          // echo '<td width="5%" align="center"></td>';
                          echo '<td><input type="checkbox" name="selectors[]" id="selectors[]"  value="' .  $result->DEFID.'"/>'. $result->PARTICULARS.'</a></td>';
