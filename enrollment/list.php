						...
						foreach ($cur as $sy) {
							...
							echo '<td>'. $sy->SEMESTER.'</td>';
					  		...
					  		if ($sy->CATEGORY == 'Registered') {
					  			echo '<a class="btn btn-warning btn-xs  "> Pay Entrance Fee to Activate</a>';
					  		}else{
					  		echo ' <a  title="Assign Subject" href="index.php?view=asignsubj&id='.$sy->IDNO.'"  class="btn btn-primary btn-xs  ">  <span class="fa fa-book fw-fa"></span></a>
					  		...
					  		<a title="Assess Subject" href="index.php?view=assess&id='.$sy->IDNO.'"  class="btn btn-primary btn-xs  ">  <span class="fa fa-bookmark fw-fa"></span></a>
					  		<a title="View Schedule" href="index.php?view=viewsced&id='.$sy->IDNO.'"  class="btn btn-primary btn-xs  ">  <span class="fa fa-bookmark fw-fa"></span></a>
					  		 <a title="Confirm Enrollment" href="controller.php?action=confirmEnrol&id='.$sy->SYID.'"  class="btn btn-primary btn-xs  ">  <span class="fa fa-edit fw-fa"></span></a>';
					  		}
					  		echo '</td>';
					  		echo '</tr>';
