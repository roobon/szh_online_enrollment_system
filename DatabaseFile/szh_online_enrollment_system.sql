...
--
-- Host: localhost
-- Generation Time: Dec 04, 2022 at 10:14 PM
...
--
-- Database: `szh_online_enrollment_system`
--
...
CREATE TABLE `grades` (
  ...
  `FIN_AVE` int NOT NULL DEFAULT '0',
...
(3, '2018-2019', 'SECOND', 2, 20004425, 'Enrolled', '2018-01-28 09:43:46', '0000-00-00 00:00:00', 'New', 'Pintuan, John kenneth'),
...
(2, 7, '20004425', 'Pintuan, John kenneth', '2018-2019', 'SECOND', '2022-12-04', 1500, 0, 'Joken Villanueva');
...
--
ALTER TABLE `ay`
  MODIFY `AY_ID` int NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `course`
  MODIFY `COURSE_ID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;

--
-- AUTO_INCREMENT for table `department`
--
ALTER TABLE `department`
  MODIFY `DEPT_ID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `grades`
--
ALTER TABLE `grades`
  MODIFY `GRADE_ID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `instructor`
--
ALTER TABLE `instructor`
  MODIFY `INST_ID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `instructorssubjects`
--
ALTER TABLE `instructorssubjects`
  MODIFY `INSSUBJ_ID` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `level`
--
ALTER TABLE `level`
  MODIFY `YR_ID` int NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `schoolyr`
  MODIFY `SYID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `subject`
--
ALTER TABLE `subject`
  MODIFY `SUBJ_ID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=439;

--
-- AUTO_INCREMENT for table `tblassessment`
--
ALTER TABLE `tblassessment`
  MODIFY `ASSESSID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `tblcashier`
--
ALTER TABLE `tblcashier`
  MODIFY `CASHID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `tblcommon_list`
--
ALTER TABLE `tblcommon_list`
  MODIFY `COMMON_ID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `tbldefaultcharges`
--
ALTER TABLE `tbldefaultcharges`
  MODIFY `DEFID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `tblrequirements`
--
ALTER TABLE `tblrequirements`
  MODIFY `REQ_ID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;
...
--
ALTER TABLE `tblsoa`
  MODIFY `SOAID` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tblstuddetails`
--
ALTER TABLE `tblstuddetails`
  MODIFY `DETAIL_ID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;

--
-- AUTO_INCREMENT for table `tblstudent`
--
ALTER TABLE `tblstudent`
  MODIFY `S_ID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;
