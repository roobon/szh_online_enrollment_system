         ...
         <div class="panel-body"> 
          ...
          <thead>
           ...
           <td colspan="5"></td>
             ...
             <tr>
              <td align="right" colspan="4"><h3>Total Payables</h3></td><th colspan="3"><h5><input type="text" class="form-control input-bg" name="totalpayables" id="totalpayables" value="'.round($totalpayables,2).'" readonly></h5></th>    
           </tr>
           <tr>
           ...
           <td colspan="2"><button type="submit" class="btn btn-primary" name="SaveCashier"  ><span class="glyphicon glyphicon-calc"></span>Save</button>
                  ...
                  echo '<tr>
              <td align="right" colspan="5">Total Payables<td>0.00</td></td>    
           </tr>'   ;      
                }
