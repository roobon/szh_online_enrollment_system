                      ...
                      <div class="col-md-8">
                        <input name="deptid" type="hidden" value="">
                         <input class="form-control input-sm" id="U_USERNAME" name="U_USERNAME" placeholder=
                            "Email Address" type="text" value="<?php echo $singleuser->ACCOUNT_USERNAME; ?>">
                      </div>
                    </div>
                  </div>
                      ...
                      <div class="col-md-8">
                       <select class="form-control input-sm" name="U_ROLE" id="U_ROLE">
                          ...
                          <option value="Registrar" <?php echo ($singleuser->ACCOUNT_TYPE=='Registrar') ? 'selected="true"': '' ; ?>>Registrar</option> 
                           <option value="Registrar" <?php echo ($singleuser->ACCOUNT_TYPE=='Cashier') ? 'selected="true"': '' ; ?>>Cashier</option> 
