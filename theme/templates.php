...
<?php if ($_SESSION['ACCOUNT_TYPE']=='Administrator') { ?> 
                   ...
                   <li class="<?php echo (currentpage() == 'category') ? "active" : false;?>">
                     ...
                     <li class="<?php echo (currentpage() == 'category') ? "active" : false;?>">
                        <a href="<?php echo WEB_ROOT; ?>instructor/"><i class="fa fa-fw fa-table"></i> Instructor Inquiry</a>
                    </li>
                    <li class="<?php echo (currentpage() == 'category') ? "active" : false;?>">
                    ...
                    <li class="<?php echo (currentpage() == 'category') ? "active" : false;?>">
                        <a href="<?php echo WEB_ROOT; ?>scheduling/"><i class="fa fa-fw fa-table"></i> Scheduling </a>
                    </li>
                      <li class="<?php echo (currentpage() == 'category') ? "active" : false;?>">
